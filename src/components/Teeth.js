...
export default function Teeth(props) {
    ...
    const handleTeethClick = (tooth) => {
        props.onChange(tooth);
    };

    return (
        <div>
            <meta charSet="UTF-8"/>
            <title>CodePen - Adult-Tooth-Chart</title>
            <link
                rel="stylesheet"
